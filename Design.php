...
window.alert("Please drop item");
 ...
 if(item[0]=='lf' && item[1]=='oil'){
 document.getElementById("product_image").src="images/lavenderInfusedoil.jpg";
  box4();
 }else if(item[1]=='lf' && item[0]=='oil'){
 ...
 box4();
    ...
    if(item[0]=='lf' && item[1]=='oil'&& item[2]=='soap'){
 
 document.getElementById("product_image").src="images/s6-unsplash.jpg";
  box4();
 }

else if(item[0]=='lf' && item[1]=='soap'&& item[2]=='oil'){
 
 document.getElementById("product_image").src="images/s6-unsplash.jpg";
  box4();
 }

else if(item[0]=='soap' && item[1]=='oil'&& item[2]=='lf'){
 
 document.getElementById("product_image").src="images/s6-unsplash.jpg";
  box4();
 }

 else if(item[0]=='soap' && item[1]=='lf'&& item[2]=='oil'){
 
 document.getElementById("product_image").src="images/s6-unsplash.jpg";
  box4();
 }

else if(item[0]=='oil' && item[1]=='lf'&& item[2]=='soap'){
...
if(item[0]=='lf' && item[1]=='oil'&& item[2]=='salt'){
 
 document.getElementById("product_image").src="images/salt1.jpg";
  box4();
 }

else if(item[0]=='lf' && item[1]=='salt'&& item[2]=='oil'){
 
 document.getElementById("product_image").src="images/salt1.jpg";
  box4();
 }

else if(item[0]=='salt' && item[1]=='oil'&& item[2]=='lf'){
 
 document.getElementById("product_image").src="images/salt1.jpg";
  box4();
 }

 else if(item[0]=='salt' && item[1]=='lf'&& item[2]=='oil'){
 
 document.getElementById("product_image").src="images/salt1.jpg";
  box4();
 }

else if(item[0]=='oil' && item[1]=='lf'&& item[2]=='salt'){
 ...
 if(item[0]=='lf' && item[1]=='oil'&& item[2]=='sugar'){
 
 document.getElementById("product_image").src="images/sugarScrub.png";
  box4();
 }

else if(item[0]=='lf' && item[1]=='sugar'&& item[2]=='oil'){
 
 document.getElementById("product_image").src="images/sugarScrub.png";
  box4();
 }

else if(item[0]=='sugar' && item[1]=='oil'&& item[2]=='lf'){
 
 document.getElementById("product_image").src="images/sugarScrub.png";
  box4();
 }

 else if(item[0]=='sugar' && item[1]=='lf'&& item[2]=='oil'){
 
 document.getElementById("product_image").src="images/sugarScrub.png";
  box4();
 }

else if(item[0]=='oil' && item[1]=='lf'&& item[2]=='sugar'){
...
function drop(ev) {
  ...
  item[top1]=document.getElementById(data).id;
  //window.alert(item[top1]);
  top1++;
...
<tr>
<td   style="width:50%;" >
  	<img id="product_image" src="st.jpg" style="   display: block; margin-left: auto; margin-right: auto;width: 50%;" id ="letred">
